...
def Trilaterate(d1, d2, d3, d4):
	if(d1_calculate[0] == True and d2_calculate[0] == True and d3_calculate[0] == True and d4_calculate[0] == True):
		...
		p0=[0,0]
		dAP = [(0,0,d1),(9,0,d2),(9,9,d3),(0,9,d4)]
...
def beginLeastDistanceAnalytic(res):
	prAP = [[0,0,d1[0]], [0,9,d2[0]], [9,9,d3[0]], [9,0,d4[0]]]
	dist = [0,0,0,0]
	lastDist = 100
	Pos = [0,0]
	xyrange = np.linspace(0.0, 9.0, 10/res)
...
ax.set_ylim((0, 9))
#buat kotak
rect=plt.Rectangle((0,0), 9, 9, fill=False)
ax.add_patch(rect)

#(1,8)
AP1 = [92,92,92,92,92,92,92,92,92,92,92,92,92,92]
AP2 = [78,78,66,66,69,69,70,70,72,72,65,65,82,82]
AP3 = [93,93,93,93,85,85,86,86,86,86,86,86,86,86]
AP4 = [90,90,90,90,90,90,90,90,90,90,90,90,90,90]
#(1,1)
AP1 = [95,95,75,75,76,76,85,85,73,73,74,74,72,72,76,76]
AP2 = [82,82,82,82,91,91,94,94,92,92,92,92,92,92,91,91]
AP3 = [93,93,93,93,86,86,93,93,93,93,93,93,93,93,93,93]
AP4 = [90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90]
#(8,1)
AP1 = [90,90,90,90,88,88,90,90,90,90,89,89,89,89,95,95]
AP2 = [91,91,91,91,95,95,95,95,95,95,95,95,95,95,95,95]
AP3 = [90,90,90,90,88,88,90,90,90,90,89,89,89,89,95,95]
AP4 = [79,79,74,74,81,81,92,92,78,78,83,83,78,78,82,82]
#(8,8)
AP1 = [93,93,93,93,93,93,93,93,93,93,93,93,94,94,94,94,94,94]
AP2 = [87,87,95,95,86,86,95,95,95,95,87,87,87,87,90,90,87,87]
AP3 = [68,68,63,63,88,88,77,77,76,76,71,71,75,75,83,83,84,84]
AP4 = [82,82,82,82,82,82,82,82,82,82,82,82,82,82,82,82,82,82]
#(4,4)
AP1 = [89,89,85,85,92,92,91,91,89,89,88,88,89,89,92,92,96,96]
AP2 = [87,87,88,88,84,84,86,86,85,85,86,86,85,85,88,88,85,85]
AP3 = [84,84,91,91,80,80,83,83,83,83,85,85,84,84,82,82,87,87]
AP4 = [82,82,82,82,82,82,82,82,82,82,82,82,82,82,82,82,82,82]
...
#[(0,0,d1),(0,10,d2),(9,10,d3),(9,0,d4)]
	circ = plt.Circle((Pos), radius=0.2, color='r', alpha=0.15)
	ax.add_patch(circ)
...
#circ = plt.Circle((0,9), radius=d2[0], color='b', alpha=0.5)
#circ2 = plt.Circle((0,9), radius=0.01, color='r', alpha=1)
#ax.add_patch(circ)
#ax.add_patch(circ2)

#circ = plt.Circle((9,9), radius=d3[0], color='b', alpha=0.5)
#circ2 = plt.Circle((9,9), radius=0.01, color='r', alpha=1)
#ax.add_patch(circ)
#ax.add_patch(circ2)

#circ = plt.Circle((9,0), radius=d4[0], color='b', alpha=0.5)
